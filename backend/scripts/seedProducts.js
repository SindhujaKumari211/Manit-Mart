...
const SEED_PRODUCTS = [
	{
		name: "Redmi Note 12, 128GB (Boxed)",
		description: "Well-maintained phone with box and charger, no scratches.",
		price: 9500,
	...
	{
		name: "Engineering Graphics & Design Textbook",
		description: "First-year drawing textbook, clean pages.",
		price: 280,
		category: "Books",
		condition: "Used",
		department: "ME",
	...
	{
		name: "Study Lamp with Flexible Neck",
		description: "LED study lamp, three brightness modes, works perfectly.",
		price: 450,
		category: "Home Decor",
		condition: "Used",
		department: "CSE",
	...
	{
		name: "Foldable Cycle, 6-Speed",
		description: "Compact foldable cycle, great for campus commute.",
		price: 5200,
		category: "Bicycles",
		condition: "Used",
		department: "CE",
	...
	},
	{
		...
		description: "Exam-approved calculator, barely used.",
		price: 850,
		category: "Stationery",
		condition: "New",
		department: "EE",
	...
	},
	{
		...
		description: "Comfortable rolling chair, adjustable height.",
		price: 2600,
		category: "Furniture",
		condition: "Used",
		department: "IT",
	...
	},
	{
		...
		description: "Silent keys, long battery life, dongle included.",
		price: 1100,
		category: "Electronics",
		condition: "Used",
		department: "CSE",
	...
	},
	{
		...
		description: "Sturdy backpack with rain cover, used twice.",
		price: 1400,
		category: "Bags",
		condition: "Used",
		department: "Chemical",
	...
	{
		name: "Induction Cooktop, 1200W",
		description: "Single-burner induction, ideal for hostel cooking.",
		price: 1250,
	...
	{
		name: "Acoustic Guitar with Bag",
		description: "Beginner-friendly acoustic guitar, soft bag included.",
		price: 4800,
...
(async () => {
	try {
		...
		if (!seller)
			throw new Error(
				"No user found to own seeded products. Register a user first.",
			);
		...
		if (removed.deletedCount) {
			console.log(
				`Removed ${removed.deletedCount} previously-seeded product(s).`,
			);
		}
